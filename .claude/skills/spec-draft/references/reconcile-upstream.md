...
`spec-draft` (および `spec-resolve` / `spec-prompts`) が PRD / Design Doc / feature doc / context / ADR と spec の整合を検証するための手順。正本 path は `Spec Workflow Contract` から取得する。
...
- 下流 phase (clarify / diagram / tasks) に進む前に `spec-sync` を提案して停止する
