...
description: >-
  The reusable documents style guide — defines the writing quality bar and
  decomposition rules for all design / context / spec documents. Use when
  authoring or reviewing PRD, Design Doc, context library, requirements, or spec
  documents to keep them unambiguous, well-scoped, and implementable.
---
