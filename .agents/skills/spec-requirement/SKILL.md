...
description: >-
  Captures user requests through dialog, drafts a requirements doc from the
  requirements template, and optionally opens a tracker issue. Use when the user
  asks to turn a request into a requirements doc or an issue.
---
# Spec Requirement
