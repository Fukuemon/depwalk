...
> 最終更新: 2026-07-14 / Status: 完了 (#21 sync phase により段階導入・dispatch 標識・性能方針・テスト観点を更新。2026-07-14 追加 sync で Lombok 生成コンストラクタ解決 (D7) / MyBatis Mapper の runtime-provided マーカー拡張 (D8) を追記)
