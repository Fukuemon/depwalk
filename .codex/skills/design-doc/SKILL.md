...
name: design-doc
description: >-
  Creates or updates the product PRD and the top-level Design Doc from
  templates. Decides whether a standalone PRD is needed, or whether Why/What
  should be merged into the Design Doc. Use when the user asks to draft a PRD, a
  Design Doc, or to define a product's Why/What/How.
---
# Design Doc
