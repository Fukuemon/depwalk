---
name: spec-resolve
description: Resolves one open question at a time from the spec's 論点 table, syncing every dependent section in the spec. Use when the user references "論点", asks "next open question", or invokes spec-resolve.
targets:
  - "*"
---
