...
- Design Doc 更新要否: 要 → **2026-07-11 の sync で反映済み** (反映内容の記録は `## 上位資料からの変更点 > Design Doc への影響`)
...
| 2026-07-11 | NEEDS_WORK (phase: sync / 2 回目)    | 1 回目の言い換えのうち fixture 行 1 箇所 (テスト / 評価方針節) が取り逃しで残存 (二重列挙パターン 6 回目)。minor: 変更履歴が実態と不一致 / 「唯一の正本」表現                                                                                                                                                                    | fixture 行を line 489 と同じ言い分けに統一。「唯一の管理箇所」へ言い換え。変更履歴を実態に合わせ更新                                                                                                                                                                                                |
| 2026-07-11 | NEEDS_WORK (phase: sync / 3 回目)    | fixture 行と「唯一の正本」の解消を確認。blocking: レビュー表 / 変更履歴が 2 回目の結果・対応を未記録 (python 置換の空振り)。minor: bullet の「反映内容の正本」残存                                                                                                                                                               | レビュー表・変更履歴を実態に同期し、「反映内容の記録は」へ言い換え                                                                                                                                                                                                                                  |
...
| 2026-07-11 | Fukuemon | sync gate 1 回目の指摘に対応: 「正本」呼称の言い換え (3 件中 2 件。fixture 行 1 箇所を取り逃し)                                                                                                                                                                                                           |
| 2026-07-11 | Fukuemon | sync gate 2 回目の指摘に対応: 取り逃した fixture 行を言い分けに統一し、「唯一の正本」→「唯一の管理箇所」等、handoff 済み spec 自身を指す「正本」呼称を全廃                                                                                                                                                |
