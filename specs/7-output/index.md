...
| Design Doc  | 成功条件 S3、Goal G3、Non Goals (ビューワ非提供)、Future Work Phase1 / Phase4                                                 | 継承                                                  |
...
- **未反映の変更提案が 3 件残っている** (phase: sync で反映するまで未解決扱い):
...
| 対象 doc / 節                                      | 変更内容                                                                                                                                                                                                                                                                                                                                                                                                           | 理由                                                                                                                                               |
| -------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------- |
| `design/features/output/DesignDoc_output.md`       | (予定) 新規作成。**D1-D7 の durable 成果すべて**の正本: 公開 entry point (`output.Write`) と Formatter / View の構造 (D6) / Console tree 構築規則 1-9 (D2 = Q3) / JSON schema と版管理 (D3) / DOT・Mermaid の I/F 要件 G-1〜G-7 (D4) / エラー境界 (D5) / graph が持つ symbol 値型 (D1) / テスト観点と fixture (D7) <!-- source: clarify (D1-D7) + track (diagram phase の entry point / tree 規則の修正を含む) --> | phase: sync の正本ハンドオフ先。ハンドオフ後、spec の該当節は「決定時スナップショット」に降格する                                                  |
...
| 2026-07-11 | Fukuemon | phase: track で `## 上位資料からの変更点` を最新化 (feature doc ハンドオフ範囲を D1-D7 全体に拡張、ADR 不要を確定)                                                                         |
